    ...
    <Form {...form}>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          {/* Warna Pin (Hanya muncul jika kategori custom) */}
          {isCustomCategory && (
            <div className="space-y-2 md:col-span-2">
              <FormField
                control={form.control}
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-semibold">
                      Warna Pin <span className="text-muted-foreground font-normal">(Untuk kategori kustom ini)</span>
                    </FormLabel>
                    <div className="flex gap-4 items-center">
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          value={field.value || "#8b5cf6"} // Default purple
                        />
                      </FormControl>
                      <span className="text-sm text-muted-foreground">Pilih warna marker untuk titik ini di peta.</span>
                    </div>
                    <FormMessage />
                  </FormItem>
                )}
